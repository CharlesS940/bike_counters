...
def is_holiday(data):
    ...
    # importing public holidays and creating variable
...
# we used cyclical encoding for the hour and weekday variables
...
def get_estimator():
    ...
    categorical_cols = ['counter_name', 'icon', 'winddir']
    ...
    # parameters were found with random search
    ...
    # defining pipeline with all the previous steps
    pipe = make_pipeline(
        data_merge,
        lockdown_dates,
        holiday_encoder,
...
# defining post_processing (setting negative values to 0)
...
# predicting and postprocessing
pred = post_processing(pipe.predict(X_test))

# storing predictions in dataframe object
